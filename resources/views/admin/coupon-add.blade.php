                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <a href="{{route('admin.coupons')}}">
                                                <div class="text-tiny">Copones</div>
                                            </a>
                                        </li>
                                        <li>
                                            <i class="icon-chevron-right"></i>
                                        ...
                                        <li>
                                            <div class="text-tiny">Nuevo Cupon</div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" method="POST" action="{{route('admin.coupon.store')}}">
                                        @csrf
                                        <fieldset class="name">
                                            <div class="body-title">Codigo de Cupon <span class="tf-color-1">*</span></div>
                                        ...
                                        <fieldset class="category">
                                            <div class="body-title">Tipo de Cupon</div>
