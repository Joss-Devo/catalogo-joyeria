...
<!--  *******************************************  FILTRO POR RANGO DE PRECIOS ***************************************-->
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <div class="price-range__info d-flex align-items-center mt-2">
                ...
                <div>
                  <span class="text-secondary">Precio Maximo: </span>
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Joyería <br /><strong>Lujo esencial</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">La joyería es el complemento ideal para transformar y realzar cualquier atuendo.</h6>
                  </div>
                </div>
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Joyería <br /><strong>Lujo esencial</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Incorpora piezas modernas con colores vibrantes o eligiendo diseños atemporales, los accesorios de joyería permiten expresar tu personalidad y mantener tu estilo actualizado.</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Joyería <br /><strong>Lujo esencial</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Creamos joyería moderna en oro y en plata de ley y nos especializamos en diseños atemporales, producción local y materiales de comercio responsable</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/shop_banner4.jpg" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
 ...
 <!--         <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size" id="pagesize" name="pagesize" style="margin: right 20px;">
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" name="orderby" id="orderby">
              <option value="-1" {{$order == -1 ? 'selected' : ''}}>Predeterminado</option>
              <option value="1" {{$order == 1 ? 'selected' : ''}}>Fecha, del más reciente al más antiguo</option>
              <option value="2" {{$order == 2 ? 'selected' : ''}}>Fecha, del más antiguo al más reciente</option>
              <option value="3" {{$order == 3 ? 'selected' : ''}}>Precio, de menor a mayor</option>
              <option value="4" {{$order == 4 ? 'selected' : ''}}>Precio, de mayor a menor</option>
